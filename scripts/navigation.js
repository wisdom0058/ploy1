...
function GoToPage(url, newTab=false)
{
    ...
    if (!newTab)
    {
        ...
        // The difference between assign and replace, is that replace() removes the URL of the current document from the document history, 
...
function GoFirstPage(urlPrefix = "./")
{
    ...
    {
        page = urlPrefix + filename + "." + fileExtension;  // page.html o page.php;
    }
    GoToPage(page);
}
